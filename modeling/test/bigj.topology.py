...
simo.set_coordinates_from_rmf("eIF3b", "test_rmfs/"+rmf_file,0, rmf_component_name=None)
...
simo.set_coordinates_from_rmf("eIF3i", "test_rmfs/"+rmf_file,0, rmf_component_name=None)
...
simo.set_coordinates_from_rmf("eIF3j", "test_rmfs/"+rmf_file,0, rmf_component_name=None)
...
simo.set_coordinates_from_rmf("eIF3g", "test_rmfs/"+rmf_file,0, rmf_component_name=None)
